...
export const metadata: Metadata = {
  title: {
    default: 'NUIX — Premium Graphic Apparel',
    template: '%s | NUIX',
  },
  description: 'Luxury editorial streetwear. Premium graphic apparel crafted for the few who define culture, not follow it.',
}
